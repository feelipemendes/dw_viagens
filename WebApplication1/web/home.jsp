<%-- 
    Document   : home
    Created on : 28/11/2016, 22:39:17
    Author     : Luiz
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!--
    VALIDAÇÃO ANTES DE ACESSAR A PAGINA TEM QUE VERIFICAR SE POSSUI
    ALGUM USUARIO LOGADO, CASO CONTRARIO REDIRECIONA PRA PAGE NOT FOUND!
-->
...
<html lang="en">
    ...
    <head>
        ...
        <title>Dw Viagens - Seja Bem Vindo!</title>
    ...
    <body id="page-top" class="index">
        ...
        <header>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <img class="img-responsive" src="img/airplane.png" alt="airplane-mark">
                        <div class="intro-text">
                            <span class="name">Enjoy your Travel</span>
                            <hr class="star-light">
                            <span class="skills">Great Travels For Great People</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        ...
                        <h1 class="text-center"> YOU KNOW NOTHING!</H1>
                    </div>
                </div>
            </div>
        </section>
