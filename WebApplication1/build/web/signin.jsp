...
<!DOCTYPE html>
<html lang="en">
    <% if (session.getAttribute("flagLogin") == "false") { 
    
    %>
    <p class="alert-danger text-center"> USER OR PASSWORD WRONG! </p>
    ...
    <body>
        <div class="container">
            ...
            <form class="form-signin col-md-3 col-md-offset-4" action="LoginServlet" method="post">
                <a href="index.jsp"> <img class="img-responsive img-center" src="img/airplane.png"></a>
